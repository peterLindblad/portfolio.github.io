import { Container, ContainerTypes } from "../layout/Container";
    ...
    <Container type={ContainerTypes.Main}>
      <Container type={ContainerTypes.InnerCentered}>
        ...
        <p>
          ...
          egestas porta orci. Sed interdum egestas enim varius pellentesque.
          Duis pellentesque ut ligula et suscipit. Vestibulum ante ipsum primis
          in faucibus orci luctus et ultrices posuere cubilia curae; Integer ac
          neque et augue pellentesque sagittis.
        </p>
      </Container>
    </Container>
  );
